...
void SetWindowTitle(int window_id, uint16_t string_id);
...
bool IsMoveLinked(int moveset_index);
...
void* OamTileNumberToVramAddress(uint16_t oam_tile_num, enum screen screen);
