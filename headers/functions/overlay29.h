...
void DisplayMonstersAndItems(void);
...
void CreateTemporaryEntity(struct entity* entity);
...
void PlayParalysisEffect(struct entity* entity);
...
void PlayDefensiveStatUpEffect(struct entity* entity, int stat_index);
void PlayOffensiveStatMultiplierUpEffect(struct entity* entity, int stat_index);
void PlayOffensiveStatMultiplierDownEffect(struct entity* entity, int stat_index);
void PlayDefensiveStatMultiplierUpEffect(struct entity* entity, int stat_index);
void PlayDefensiveStatMultiplierDownEffect(struct entity* entity, int stat_index);
...
bool DisplayThrownItemShadow(int16_t x, int16_t y);
...
void SpawnEnemyTrapAtPos(enum trap_id trap_id, int16_t x, int16_t y, uint8_t flags,
                         bool is_visible);
void CreateTrapAndStairsHallucinations(void);
...
void TryPointCameraToFarOffTeammate(struct entity* entity);
void TryPointCameraToMonster(struct entity* entity, undefined param_2, bool discover_minimap);
...
void DisplayMonsterShadow(bool display_shadow, enum shadow_type shadow_type, bool yellow_circle,
                          int16_t x, int16_t y);
void DisplayMonster(struct entity* entity);
...
void ResetTypeChanges(struct entity* user);
...
bool TryInflictLeechSeedStatus(struct entity* user, struct entity* target, bool log_failure,
                               bool check_only);
void EndLeechSeedClassStatusForAllTargets(struct entity* user);
...
bool HasLastUsedMove(struct move* moves);
...
void WaitUntilFadeIsFinished(enum screen screen);
